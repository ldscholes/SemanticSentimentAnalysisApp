 ...
 */
public class ListActivityWhopper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHolidayViewModel.getWhopperHolidays().observe(this, new Observer<List<Holiday>>() {
            @Override
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListActivityWhopper.this, NewHolidayActivity.class);
        ...
        ItemTouchHelper helper = new ItemTouchHelper(
                new ItemTouchHelper.SimpleCallback(0,
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                        ...
                        Toast.makeText(ListActivityWhopper.this,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_HOLIDAY_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            if (id != -1) {
                mHolidayViewModel.update(new Holiday(id, holiday_data, holiday_note_data, holiday_opinion_data, "Whopper"));
            } else {

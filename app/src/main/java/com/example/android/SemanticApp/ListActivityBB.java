 ...
 */
public class ListActivityBB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHolidayViewModel.getBBHolidays().observe(this, new Observer<List<Holiday>>() {
            @Override
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListActivityBB.this, NewHolidayActivity.class);
        ...
        ItemTouchHelper helper = new ItemTouchHelper(
                new ItemTouchHelper.SimpleCallback(0,
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                        ...
                        Toast.makeText(ListActivityBB.this,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        System.out.println(data.getStringExtra(NewHolidayActivity.EXTRA_REPLY));
        System.out.println(data.getStringExtra(NewHolidayActivity.EXTRA_REPLY_NOTE));
        System.out.println(data.getStringExtra(NewHolidayActivity.EXTRA_REPLY_OPINION));


        String holiday_data = data.getStringExtra(NewHolidayActivity.EXTRA_REPLY);
        String holiday_note_data = data.getStringExtra(NewHolidayActivity.EXTRA_REPLY_NOTE);
        ...
        if (requestCode == NEW_HOLIDAY_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            if (id != -1) {
                mHolidayViewModel.update(new Holiday(id, holiday_data, holiday_note_data, holiday_opinion_data, "BBGUNS4LESS"));
            } else {
